...
class UnitSummary:
    ...
    def __new__(
        ...
        gs_3 = fig.add_gridspec(3, 6, hspace=0.01, wspace=1, left=0.44, right=0.60, top=0.96, bottom=0.73)
        ...
        kernels[2].plot_raw(type="valley", ax_in=ax_kern_csg)
        ...
        kernels[3].plot_raw(type="valley", ax_in=ax_kern_isg)
